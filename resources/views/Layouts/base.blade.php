                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo"  >
                                    <a href="index.htm">
                                        <img src="{{asset('assets/images/logoH.png')}}" class="logo"  img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="{{asset('assets/images/logoH.png')}}" style="margin-top: -25px" class="logo"  img-fluid blur-up lazyload"
                                    alt="logo">
                                </a>
                            </div>
                                <ul class="contact-lists" style="clear:both;" >
                                    <li>
                                        <span><b>Owner of website</b> <span class="font-light"> HATIM ILYAS</span></span>
                                    </li>
                                    <li>
                                        <span><b>phone:</b> <span class="font-light"> 0612951718</span></span>
                                    </li>
                                    <li>
                                        <span><b>Email:</b><span class="font-light"> Hatimilyas766@gmail.com</span></span>
                                    </li>
                                </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, HOLAZOMI. / HATIM ILYAS </p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div>
                            ...
                            <div class="modal-product">
                                <div class="modal-contain-img">
                                    <img src="{{ asset('assets/images/fashion/instagram/4.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    alt="">
                                </div>
